...
Misal kekuatan pada level ke-N di representasikan dengan pecahan sederhana $\frac{A}{B}$, Keluaran sebuah nilai X dimana X memenuhi $0\leq X \leq 1.000.000.006$, dan $X \cdot A \equiv B \mod 1.000.000.007$
\\
